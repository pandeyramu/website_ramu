...
urlpatterns = [
    ...
    path('blog/chapter-wise-marks-distribution/', views.blog_post, {'slug': 'chapter-wise-marks-distribution'}, name='blog_chapter_wise_marks_distribution'),
    path('blog/last-30-days-cee-prep-plan/', views.blog_post, {'slug': 'last-30-days-cee-prep-plan'}, name='blog_last_30_days_cee_prep_plan'),
    path('blog/how-to-remember-organic-reactions/', views.blog_post, {'slug': 'how-to-remember-organic-reactions'}, name='blog_how_to_remember_organic_reactions'),
